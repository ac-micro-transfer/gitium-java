...
import com.gitium.core.model.Input;
...
public class InputValidator {
     ...
     **/
    public static boolean isAddressesCollectionValid(final List<String> addresses) throws GitiumException {
     ...
     * @return <code>true</code> if the specified addresses are valid; otherwise, <code>false</code>.
     **/
    public static boolean isAddressesArrayValid(String[] addresses) throws GitiumException {
     ...
     **/
    public static boolean checkAddress(String address) throws GitiumException {
     ...
     * @throws ArgumentException when the specified input is not valid.
     **/
    public static boolean isTransfersCollectionValid(final List<Transfer> transfers) throws GitiumException {
